...
"Given the natural extinction rate, we would not expect more than one amphibian extinction per century. According to scientists, 2,341 are currently at risk for extinction during that time. Frogs have been hit hard, with families like the <a onClick='showMe(\"waterfrogs\");' class='showmetext'><span class='showmebox'>water frog</span></a>, <a onClick='showMe(\"shrubfrogs\");' class='showmetext'><span class='showmebox'>shrub frog</span></a>, and <a onClick='showMe(\"dancingfrogs\");' class='showmetext'><span class='showmebox'>dancing frog</span></a> in great danger."},
{"class":"mammals", "copy":"Given the natural extinction rate, we would not expect more than one mammal species go extinct per century. According to scientists, 1,469 are currently in danger of extinction during that time. Note the red cluster at <a onClick='showMe(\"primates\");' class='showmetext'><span class='showmebox'>primates</span></a>, especially <a onClick='showMe(\"lemurs\");' class='showmetext'><span class='showmebox'>lemurs</span></a>. <a onClick='showMe(\"rhinos\");' class='showmetext'><span class='showmebox'>Rhinos</span></a>, <a onClick='showMe(\"bears\");' class='showmetext'><span class='showmebox'>bears</span></a> & <a onClick='showMe(\"cats\");' class='showmetext'><span class='showmebox'>big cats</span></a> are also at risk."},
{"class":"reptiles", "copy": "Given the natural extinction rate, we would not expect more than one reptile extinction per century. According to scientists, 1,163 are currently at risk for extinction during that time. There is a striking red cluster around the order of <a onClick='showMe(\"turtles\");' class='showmetext'><span class='showmebox'>turtles</span></a>, as well as the <a onClick='showMe(\"chameleons\");' class='showmetext'><span class='showmebox'>chameleon</span></a> and <a onClick='showMe(\"iguanas\");' class='showmetext'><span class='showmebox'>iguana</span></a> families."},
{"class":"birds", "copy":"Given the natural extinction rate, we would not expect more than one bird extinction per century. According to the IUCN, 2,200 are currently in danger of extinction during that time. <a onClick='showMe(\"albatrosses\");' class='showmetext'><span class='showmebox'>Albatrosses</span></a>, <a onClick='showMe(\"penguins\");' class='showmetext'><span class='showmebox'>penguins</span></a>, <a onClick='showMe(\"hornbills\");' class='showmetext'><span class='showmebox'>hornbills</span></a> and <a onClick='showMe(\"parrots\");' class='showmetext'><span class='showmebox'>parrots</span></a> are particularly at risk."}
]
...
function updateFamilyTooltip() {
	...
	var showtext = commonname+": "+threatstat;
	familytooltip.text(showtext);
	familytooltip
		.style("left", getFamilyTooltipX)
		//getFamilyTooltipX(selectedfamily, showtextlength)+"px")//+focuswidth+8+"px")
		.style("top", familytooltipy+"px")//(getSpeciesFocusY(d)+(classdata[currclassindex].focusheight/2.0))+"px")
		.style("display", "block")
		.style("font-weight", 600);
}

function getFamilyTooltipX() {
		var w = d3.select(this)[0][0].innerHTML.width();
		var xposition = Math.max(focusx0, getFocusXFromGenus(selectedfamily.firstgenus));

		if ((xposition+w)>(focusx0+focusgraphwidth)) {
			return Math.min((getFocusXFromGenus(selectedfamily.lastgenus)+4-w), (focusx0+focusgraphwidth-w))+"px"
		} else {
			return xposition+"px";
		}
...
/**
function getFamilyTooltipX(selectedfamily, showtextlength) {
	Math.max(x0, getFocusXFromGenus(selectedfamily.firstgenus))
}**/
