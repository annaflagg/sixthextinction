...
"Given the natural extinction rate, we would not expect more than one amphibian extinction per century. However according to the IUCN, 2,341 are currently at risk for extinction. Frogs have been hit hard, with families like the <a onClick='showMe(\"waterfrogs\");' class='showmetext'><span class='showmebox'>water frog</span></a>, <a onClick='showMe(\"shrubfrogs\");' class='showmetext'><span class='showmebox'>shrub frog</span></a>, and <a onClick='showMe(\"dancingfrogs\");' class='showmetext'><span class='showmebox'>dancing frog</span></a> in great danger."},
{"class":"mammals", "copy":"Given the natural extinction rate, we would not expect more than one mammal species go extinct per century. However according to the IUCN, 1,469 are currently in danger of extinction. Note the red cluster at <a onClick='showMe(\"primates\");' class='showmetext'><span class='showmebox'>primates</span></a>, especially <a onClick='showMe(\"lemurs\");' class='showmetext'><span class='showmebox'>lemurs</span></a>. <a onClick='showMe(\"rhinos\");' class='showmetext'><span class='showmebox'>Rhinos</span></a>, <a onClick='showMe(\"bears\");' class='showmetext'><span class='showmebox'>bears</span></a> & <a onClick='showMe(\"cats\");' class='showmetext'><span class='showmebox'>big cats</span></a> are also at risk."},
{"class":"reptiles", "copy": "Given the natural extinction rate, we would not expect more than one reptile extinction per century. However according to the IUCN, 1,163 are currently at risk for extinction. There is a striking red cluster around the order of <a onClick='showMe(\"turtles\");' class='showmetext'><span class='showmebox'>turtles</span></a>, as well as the <a onClick='showMe(\"chameleons\");' class='showmetext'><span class='showmebox'>chameleon</span></a> and <a onClick='showMe(\"iguanas\");' class='showmetext'><span class='showmebox'>iguana</span></a> families."},
